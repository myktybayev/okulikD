...
public class OyinActivity1 extends AppCompatActivity implements View.OnClickListener {

    TextView tv_upai, card_front1, card_back1, card_front2, card_back2, card_front3, card_back3, card_front4, card_back4, card_front5, card_back5, card_front6, card_back6;
    boolean isCardOpen1, isCardOpen2, isCardOpen3, isCardOpen4 , isCardOpen5, isCardOpen6 = false;
    AnimatorSet front1, back1, front2, back2, front3, back3, front4, back4, front5, back5, front6, back6;
    int upaiCount = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_oyin1);
        initViews();
    }
        ...
        if(cardText1.equals(cardText2)){
            ...
            if(upaiCount == 30){
                ...
                if(loginCursor!=null & loginCursor.getCount() > 0) {
                    ...
                    userValue.put(COLUMN_GAME_NUMBER, "oiyn1");
                    userValue.put(COLUMN_UPAI, "30");
                    ...
                    if (test != null & test.getCount() > 0) {
                        ...
                        Log.i("games", "testEmail: " + testEmail);
                        Log.i("games", "testGN: " + testGN);
                        Log.i("games", "testUpai: " + testUpai);
                    }
